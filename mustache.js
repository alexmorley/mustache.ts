...
var Writer = /** @class */ (function () {
     ...
     */
    Writer.prototype.parseTemplate = function (template, tags) {
        if (!template)
            return [];
     ...
     * to a single token.
     */
    Writer.prototype.squashTokens = function (tokens) {
        var squashedTokens = [];
        var token, lastToken;
     ...
     */
    Writer.prototype.nestTokens = function (tokens) {
        var nestedTokens = [];
    ...
    ;
    Writer.prototype.renderPartial = function (token, context, partials, originalTemplate) {
        if (!partials)
            return;
...
var MustacheEngine = /** @class */ (function () {
     ...
     */
    MustacheEngine.prototype.clearCache = function () {
     ...
     * default writer.
     */
    MustacheEngine.prototype.render = function (template, view, partials) {
    ...
    MustacheEngine.prototype.to_html = function (template, view, partials, send) {
        /*eslint-enable*/
...
module.exports = new MustacheEngine();
